...
> 对应规划见 [PLAN.md](./PLAN.md)；里程碑见 [docs/M1-COMPLETE.md](./docs/M1-COMPLETE.md) ~ [docs/M21-COMPLETE.md](./docs/M21-COMPLETE.md)。
...
**当前代码里程碑**：**M21 已实现**（…M20 Polygon 同步/解读 → **M21 Polygon zip 导入工件 + 对拍反例自动归档**）。**反例载入编辑器** 仍在 M22+ 规划中。
